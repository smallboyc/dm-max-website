      ...
      <div className="mx-auto max-w-2xl text-center">
        <div className="flex flex-col items-center gap-5">
          ...
          <Text align={Text.align.CENTER} size={Text.size.LARGE}>
            Need a service or just contact me? No problem!
          </Text>
        </div>
      </div>
      <form
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <Switch.Group as="div" className="flex gap-x-4 sm:col-span-2">
            <div className="flex h-6 items-center">
              <Switch
                ...
                className={classNames(
                  agreed ? "bg-variation" : "bg-gray-200",
                  "flex w-8 flex-none cursor-pointer rounded-full p-px ring-1 ring-inset ring-gray-900/5 transition-colors duration-200 ease-in-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-variation"
                )}
              >
            ...
            <Switch.Label className="text-sm leading-6 text-gray-600">
              By selecting this, you will receive my{" "}
              <a href="#" className="font-semibold text-variation">
                latest&nbsp;news
              </a>
              .
            </Switch.Label>
